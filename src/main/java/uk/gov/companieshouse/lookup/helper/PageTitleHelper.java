...
public class PageTitleHelper {
    ...
    private final static String CONFIRMATION_STATEMENT_TITLE="title.formtype.confirmation-statement";
    private final static String DEFAULT_TITLE="company.number.title";
